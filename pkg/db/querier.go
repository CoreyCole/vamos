...
type Querier interface {
	...
	GetImplWorkspace(ctx context.Context, workspaceSlug string) (ImplWorkspace, error)
	...
	ListCurrentPlanWorkspaces(ctx context.Context) ([]PlanWorkspace, error)
	...
	ListPlanWorkspaces(ctx context.Context) ([]PlanWorkspace, error)
