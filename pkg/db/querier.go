...
type Querier interface {
	...
	ArchivePlanWorkspacePrimaryProjects(ctx context.Context, planDirRel string) (int64, error)
	...
	GetSharedAgentThread(ctx context.Context, id string) (AgentThread, error)
	...
	ThreadHasWorkspaceAssociation(ctx context.Context, arg ThreadHasWorkspaceAssociationParams) (int64, error)
