...
func WorkbenchV2ChromeNames() []VTChromeName {
	...
	return []VTChromeName{
		...
		},
		{
			...
			Class:     chrome,
			Freeze:    true,
			ProbeKey:  "chatComments",
			DocsMedia: "named `@media (max-width: 767px)` only; `view-transition-name: none` on `md+`",
		},
		{
			Selector:  "#workbench-v2-threads",
			Name:      "workbench-v2-threads",
		...
		{
			Selector:  "#workbench-v2-threads-reopen",
			Name:      "workbench-v2-threads-reopen",
			Media:     VTChromeMediaDesktop,
			Class:     chrome,
			Freeze:    true,
			ProbeKey:  "threadsReopen",
		...
		{
			Selector:  "#workbench-v2-comments",
			Name:      "workbench-v2-comments",
			Media:     VTChromeMediaAll,
			Class:     chrome,
			Freeze:    true,
			ProbeKey:  "comments",
		...
		{
			Selector:  "#thread-artifact-path-header",
			Name:      "thread-artifact-path-header",
			Media:     VTChromeMediaAll,
			Class:     chrome,
			Freeze:    true,
			ProbeKey:  "path",
