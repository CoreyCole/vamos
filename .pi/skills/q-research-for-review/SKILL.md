...
1. Read `.pi/skills/q-research/SKILL.md` and follow its research process unless this skill overrides it.
1. Read `.pi/skills/q-review-plan/SKILL.md` to understand the three planning-review categories:
   - `obvious_doc_fix`
