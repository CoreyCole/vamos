...
Run project-defined checks, inspect artifacts/UI as appropriate, fix clear bounded defects, write `verify.md`, and stop for final human approval when evidence is ready.
