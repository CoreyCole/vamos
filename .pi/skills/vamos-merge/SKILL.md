...
- Pi and the stable CLI launcher dogfood directly from `../vamos`; there is no separate skill/runtime mirror to synchronize. Promote verified commits to `../vamos-main` only after stage validation.
...
- Pi skill and launcher dogfood source (`../vamos`) status/HEAD
