...
Read the handoff, plan memory, current plan status, and only needed artifacts. Confirm the workspace is safe, then perform one bounded pending activity and create a replacement handoff or final completion.
