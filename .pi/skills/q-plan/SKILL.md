...
Read relevant code before planning. Write vertical slices with verification and conventional commit guidance, run the project artifact sync when available, then recommend planning review.
