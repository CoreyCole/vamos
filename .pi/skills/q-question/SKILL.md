...
When the question doc is written, emit this fenced YAML result, followed by the mandatory concise human summary.

Post-YAML natural summary format for this stage: list research questions as concisely as possible, one question per line. Caveman speak. Few words. Most important words only. Use:
