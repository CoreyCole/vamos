...
Inspect the code, tests, and handoffs. Apply straightforward fixes as bounded review work; create a nested follow-up plan for deeper work. When clean, write the canonical review artifact and recommend `verify`.
