...
description: Apply review research to planning artifacts.
---

# q-address-review-research

Update the parent design, optional product design, outline, and plan from review findings and factual research; then recommend the appropriate planning review or next safe activity.
