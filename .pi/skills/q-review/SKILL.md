...
- Planning review always includes intent-fit, simplicity, project-guidance, and docs-health lanes. Implementation review always includes correctness, simplicity, project-guidance, and docs-health lanes. The project-guidance reviewer owns discovery and enforcement of applicable root/path-scoped `AGENTS.md`, `.agents/rules/`, `.agents/skills/`, and nearby package docs.
